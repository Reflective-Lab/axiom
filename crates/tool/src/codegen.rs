...
///
/// ```
/// use converge_axiom::codegen::ManifestBuilder;
/// use converge_axiom::gherkin::{ScenarioMeta, ScenarioKind, InvariantClassTag};
///
...
///
/// ```
/// use converge_axiom::codegen::{generate_invariant_module, CodegenConfig};
/// use converge_axiom::predicate::Predicate;
///
...
pub fn generate_invariant_module(config: &CodegenConfig, predicates: &[Predicate]) -> String {
    ...
    s.push_str("//!\n");
    s.push_str("//! Generated by converge-axiom. Do not edit manually.\n\n");
