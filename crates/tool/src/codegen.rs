...
///
/// ```
/// use converge_tool::codegen::{generate_invariant_module, CodegenConfig};
/// use converge_tool::predicate::Predicate;
///
...
pub fn generate_invariant_module(config: &CodegenConfig, predicates: &[Predicate]) -> String {
    ...
    s.push_str("//!\n");
    s.push_str("//! Generated by converge-tool. Do not edit manually.\n\n");
