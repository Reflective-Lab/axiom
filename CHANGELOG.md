...
- Security workflows keep `cargo audit --deny warnings` strict while scope-ignoring three known upstream stack advisories until fixed stack crates are published.
