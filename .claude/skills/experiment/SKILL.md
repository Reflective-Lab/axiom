...
2. **Assign an ID**: `EXP-<NNN>` (next sequential number from `kb/Experiments/LOG.md`).

3. **Create the experiment file**: `kb/Experiments/EXP-<NNN>.md` using this template:
```markdown
# EXP-<NNN>: <short title>
**Date:** <YYYY-MM-DD>
...
6. **Conclude** — update status and outcome. Append a one-liner to `kb/Experiments/LOG.md`.

## Log Format (`kb/Experiments/LOG.md`)
```markdown
# Experiment Log
...
1. Read `kb/Experiments/EXP-<NNN>.md`
